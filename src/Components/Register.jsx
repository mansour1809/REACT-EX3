...
function Register() {
  ...
  return (
    ...
    />      <input type="password" name="confirmPassword" placeholder="Confirm Password" onChange={(e)=>handleChange("confirmPassword" , e)} required />
     <input type="file" name="img" placeholder="Profile Picture" onChange={(e)=>handleChange("img" , e)} />
    ...
    <datalist id="cities">
     ...
     <input type="text" name="street" placeholder='Street' pattern="[\u0590-\u05FF\s]+"  title="Street name must contain only Hebrew letters." onChange={(e)=>handleChange("street" , e)}/>
